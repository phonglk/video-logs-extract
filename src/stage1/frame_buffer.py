"""
DEPRECATED: This module is kept for compatibility but is no longer actively used.
Please use the OptimizedFrameBuffer from src.optimized_processor instead.
"""

import warnings
warnings.warn(
    "The FrameBuffer class is deprecated. Please use OptimizedFrameBuffer from "
    "src.optimized_processor instead.", DeprecationWarning, stacklevel=2
)
...
class FrameBuffer:
    """
    DEPRECATED: Please use OptimizedFrameBuffer from src.optimized_processor.
    
    Simple frame buffer for reading, buffering and preparing video frames.
    """

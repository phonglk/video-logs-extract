...
class ProgressManager:
    ...
    def set_video_info(self, fps: float, duration: float) -> None:
    ...
    def update(self, processed: int = 0, saved: int = 0, skipped: int = 0, batch_size: int = 0) -> None:
        ...
        # Update display at most once every 0.1 seconds
    ...
    def _display_progress(self, force: bool = False) -> None:
        ...
        sys.stdout.write('\r' + stats[:self.terminal_width-1])
        sys.stdout.flush()
...
class FrameManager:
    ...
    def save_frame(self, 
        ...
        """Save frame with metadata if time threshold is met."""
